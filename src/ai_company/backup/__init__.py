...
- :mod:`ai_company.backup.backup` — create timestamped tar.gz bundles of
  ...
  .ai-company/) that are gitignored and have no other off-box copy.
- ``python -m ai_company.backup`` — command line entry point.
"""

from ai_company.backup.backup import DEFAULT_SOURCE_DIRS, create_backup

__all__ = ["DEFAULT_SOURCE_DIRS", "create_backup"]
