...
| Field | Value |
|---|---|
| **Current Sprint** | Sprint 5.5 - Phase 3: OpenCode desktop as first-class command center - **IN PROGRESS (P1 + P2 + P3 + P4 + P5 SHIPPED)** |
| **Status** | **IN PROGRESS** - P1 (session bridge AGENTS.md, `f8c5389`) + P2 (session telemetry-on-close, `8e07d9d` + fix `16a43a2`) + P3 (dashboard -> desktop deep links, `ad488a8`) + P4 (desktop -> submit for review, `2d3b6d6`) + P5 (GUI/desktop action telemetry, `42ccc4e`) SHIPPED; suite **1428 green**; P6 next |
...
| **Commit** | Sprint 5.5: P5 `42ccc4e` / P4 `2d3b6d6` / P3 `ad488a8` / P1 `f8c5389` / P2 `8e07d9d` / P2 fix `16a43a2` / Sprint 5.4 closed `4ca321f` / T1 `294e107` / T2 `11fde80` / T3 `f690133` / T4 `9dba281` / T5 `b93a886` / Sprint 5.3 `de9c851` |
...
11d. **Sprint 5.5 P5 SHIPPED (2026-08-04, `42ccc4e`)** — GUI/desktop action
    ...
    → gui 1, share 14.2% rendered). **Next: P6 R3 parity milestone advance
    (≥40/71 rows).**
