...
| **Status** | 🔄 **IN PROGRESS** — T4 (recovery-success metric) built + gated, commit next; T1 shipped; T2/T3 pending; T5 stretch |
...
| **Commit** | Sprint 5.4 T4: pending commit · Sprint 5.4 T1: `294e107` · Sprint 5.3: `de9c851` · Wave 2b: `2244497` · Wave 2a: `131d9d9` |
| **Created** | 2026-08-02 |
| **Completed** | — |
...
### Sprint 5.4 T4 Deliverables — Recovery-success metric (BUILT, gating/commit next)
